package org.commonjava.maven.plugins.monolith.versions;
...
public class VersionCalculator
{
    ...
    public VersionCalculator( final String versionSuffix, final boolean increment )
    {
        suffix = versionSuffix;
        incrementSerial = increment;
    }
